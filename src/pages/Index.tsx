      ...
      <AnimatedSection className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center py-32">
          <AnimatedDiv animation="fade-up">
            <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-poppins font-semibold text-primary-foreground leading-tight max-w-5xl mx-auto">
              {t.home.hero.title}
            </h1>
          </AnimatedDiv>
          <AnimatedDiv animation="fade-up" delay={100}>
            <p className="mt-8 text-lg md:text-xl font-poppins font-light text-primary-foreground/80 max-w-3xl mx-auto">
              {t.home.hero.subtitle}
            </p>
          </AnimatedDiv>
          <AnimatedDiv animation="fade-up" delay={200}>
            <div className="mt-12">
              <Link to="/produits">
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {t.home.values.items.map((value, index) => {
              ...
              return (
                <AnimatedDiv animation="fade-up" delay={index * 100} key={index}>
                  <Card
                    variant="elevated"
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {(['marbre' , 'marble', 'granite', 'onyx'] as const).map((category, index) => {
              ...
              return (
                <AnimatedDiv animation="fade-up" delay={index * 100} key={category}>
          ...
          <AnimatedDiv animation="fade-up" delay={400}>
